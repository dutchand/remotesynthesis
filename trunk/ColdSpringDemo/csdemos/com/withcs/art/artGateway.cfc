...
<cfcomponent displayname="artGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="com.withcs.art.artGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","com.withcs.art.art").init(argumentCollection=queryRowToStruct(qList,i)) />
