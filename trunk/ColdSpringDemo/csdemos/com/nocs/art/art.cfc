...
<cfcomponent displayname="art" output="false">
		...
		<cfproperty name="ARTIST" type="com.nocs.artists.artist" default="" />
	...
	--->
	<cffunction name="init" access="public" returntype="com.nocs.art.art" output="false">
		<cfargument name="ARTID" type="string" required="false" default="" />
		<cfargument name="ARTIST" type="com.nocs.artists.artist" required="false" default="#createObject('component','com.nocs.artists.artist').init()#" />
	...
	<cffunction name="getARTIST" access="public" returntype="com.nocs.artists.artist" output="false">
