...
<cfcomponent name="consoleServiceRemote" 
			displayname="consoleServiceRemote:RemoteProxyBean" 
	...
	<cffunction name="setup" access="public" returntype="void">
		...
		<cftry>		
			...
			<cfset remoteFactory = bf.getBean("&consoleService_remote") />
			<cfset variables.target = bf.getBean("consoleService_remote") />
	...
	<cffunction name="getGames" access="remote" returntype="any" output="false" > 
...
<cfset var rtn = callMethod('getGames', arguments) />
