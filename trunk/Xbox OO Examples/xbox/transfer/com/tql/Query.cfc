...
<cffunction name="setParam" hint="Sets a mapped parameter" access="public" returntype="void" output="false">
	...
	<cfargument name="null" hint="If the value is actually null" type="boolean" required="No" default="false">
	<cfscript>
		if(NOT (StructKeyExists(arguments, "value") OR arguments.null))
		{
