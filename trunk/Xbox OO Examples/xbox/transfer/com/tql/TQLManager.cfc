...
<cffunction name="init" hint="Constructor" access="public" returntype="TQLManager" output="false">
	...
	<cfscript>
		var tqlParser = createObject("component", "TQLParser").init(arguments.javaLoader);

		setQueryPool(createObject("component", "transfer.com.tql.collections.QueryPool").init());
		setSelectStatement(createObject("component", "SelectStatement").init(tqlParser, arguments.objectManager, arguments.datasource));
		return this;
	</cfscript>
</cffunction>
