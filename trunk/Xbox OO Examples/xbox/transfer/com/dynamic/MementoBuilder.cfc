...
<cffunction name="add" hint="Add a set of memento values to the collection" access="public" returntype="void" output="false">
	...
	<cfscript>
		...
		{
			memento = createObject("component", "Memento").init(arguments.className, arguments.structValue);
...
<cffunction name="getCompositePathKey" hint="returns the key in a common fasion" access="private" returntype="string" output="false">
	<cfargument name="className" hint="the classname of the parent" type="string" required="Yes">
	<cfargument name="key" hint="The primary key value" type="string" required="Yes">
...
<cffunction name="getMemento" access="private" returntype="transfer.com.dynamic.Memento" output="false">
	<cfreturn instance.memento />
</cffunction>

<cffunction name="setMemento" access="private" returntype="void" output="false">
	<cfargument name="Memento" type="transfer.com.dynamic.Memento" required="true">
...
<cffunction name="addToCollection" hint="Adds the memento to the collection" access="private" returntype="void" output="false">
	...
	<cfargument name="memento" hint="The memento object to add" type="transfer.com.dynamic.Memento" required="Yes">
...
<cffunction name="getFromCollection" hint="Retrieves a Memento object from the collection" access="private" returntype="transfer.com.dynamic.Memento" output="false">
	<cfargument name="className" hint="The classname for the memento" type="string" required="Yes">
	<cfargument name="key" hint="The key value" type="string" required="Yes">
	<cfscript>
