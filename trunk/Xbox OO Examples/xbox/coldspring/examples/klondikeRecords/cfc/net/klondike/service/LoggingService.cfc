<!--- 
  ...
  $Id: LoggingService.cfc,v 1.1 2005/10/09 20:12:06 scottc Exp $
  $Log: LoggingService.cfc,v $
...
<cfcomponent name="LoggingService" displayname="LoggingService" hint="Abstract service">

	<cffunction name="init" returntype="void">
		<cfthrow type="InvalidConstructor" message="abstract component 'SecurityService' cannot be instantiated"/>
	</cffunction>
