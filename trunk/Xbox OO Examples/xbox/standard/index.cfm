...
<!--- create our dependencies to pass in...can you see why ColdSpring is a good idea? --->
	<cfset consoleDAO = createObject("component","standard.com.xbox.consoleDAO").init(dsn) />
	<cfset consoleGateway = createObject("component","standard.com.xbox.consoleGateway").init(dsn) />
	<cfset controlDAO = createObject("component","standard.com.xbox.controls.controlDAO").init(dsn) />
	<cfset controlGateway = createObject("component","standard.com.xbox.controls.controlGateway").init(dsn) />
	<cfset accessoryDAO = createObject("component","standard.com.xbox.accessories.accessoryDAO").init(dsn) />
	<cfset accessoryGateway = createObject("component","standard.com.xbox.accessories.accessoryGateway").init(dsn) />
	<cfset gameDAO = createObject("component","standard.com.xbox.games.gameDAO").init(dsn) />
	<cfset gameGateway = createObject("component","standard.com.xbox.games.gameGateway").init(dsn) />

<cfset consoleService = createObject("component","standard.com.xbox.consoleService").init(consoleDAO,consoleGateway,controlDAO,controlGateway,accessoryDAO,accessoryGateway,gameDAO,gameGateway) />
