<!--- 
  ...
  $Id: LoggingService.cfc,v 1.1 2005/10/09 20:12:05 scottc Exp $
...
<cfcomponent name="LoggingService"
			extends="net.klondike.service.LoggingService" displayname="LoggingService" hint="Service for Logging">
