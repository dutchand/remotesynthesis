...
<cffunction name="writeCFFunctionOpen" hint="Writes the opening part of a CFFunction" access="public" returntype="void" output="false">
	...
	<cfscript>
		append("<cffunction name=" & q() & arguments.name & q());
...
<cffunction name="writeCFArgument" hint="Writes an argument to the buffer" access="public" returntype="void" output="false">
	...
	<cfargument name="type" hint="The type of the argument" type="string" required="Yes">
	<cfargument name="required" hint="Whether the argument is required" type="boolean" required="Yes">
...
<cffunction name="writeLazyLoad" hint="writes the check if it's loaded, and calls it's load method" access="public" returntype="void" output="false">
