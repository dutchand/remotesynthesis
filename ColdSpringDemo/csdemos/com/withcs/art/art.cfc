<cfcomponent displayname="art" output="false">
		...
		<cfproperty name="ARTIST" type="com.withcs.artists.artist" default="" />
	...
	--->
	<cffunction name="init" access="public" returntype="com.withcs.art.art" output="false">
		<cfargument name="ARTID" type="string" required="false" default="" />
		<cfargument name="ARTIST" type="com.withcs.artists.artist" required="false" default="#createObject('component','com.withcs.artists.artist').init()#" />
	...
	<cffunction name="getARTIST" access="public" returntype="com.withcs.artists.artist" output="false">
