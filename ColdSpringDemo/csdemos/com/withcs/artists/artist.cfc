<cfcomponent displayname="artist" output="false">
	...
	--->
	<cffunction name="init" access="public" returntype="com.withcs.artists.artist" output="false">
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="com.withcs.artists.artist" output="false">
