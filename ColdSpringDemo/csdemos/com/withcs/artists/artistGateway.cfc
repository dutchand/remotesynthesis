...
<cfcomponent displayname="artistGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="com.withcs.artists.artistGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","com.withcs.artists.artist").init(argumentCollection=queryRowToStruct(qList,i)) />
