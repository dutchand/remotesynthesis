<cfcomponent displayname="artDAO">
	...
	<cffunction name="init" access="public" output="false" returntype="com.withcsoption2.art.artDAO">
	...
	<cffunction name="read" access="public" output="false" returntype="void">
		...
		<cfif qRead.recordCount>
			...
			<cfif len(qRead.artistID)>
				<cfset artist = createObject("component","com.withcsoption2.artists.artist").init(artistID=qRead.artistID) />
