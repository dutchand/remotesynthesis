...
<cfcomponent displayname="artistGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="com.withcsoption2.artists.artistGateway">
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","com.withcsoption2.artists.artist").init(argumentCollection=queryRowToStruct(qList,i)) />
